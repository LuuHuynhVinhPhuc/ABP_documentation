...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p dc53cdd7-3709-481e-80b0-39bc18c328d3
```

> `dc53cdd7-3709-481e-80b0-39bc18c328d3` is the password of the certificate, you can change it to any password you want.
